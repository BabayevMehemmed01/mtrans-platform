      ...
      <div className="rounded-2xl border border-gray-200/80 bg-white p-6 space-y-5 shadow-sm">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Məsələn: Qlobal Marketinq və Satış İnteqrasiyası"
        ...
        {/* Description */}
        <div>
          <label className="block text-[13px] font-bold text-slate-700 mb-1.5">Məqsəd və Təsvir</label>
          <textarea
            name="description"
            value={form.description}
            onChange={handleChange}
            rows={4}
            placeholder="Bu ortaq layihənin məqsədi nədir?..."
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-[13px] font-bold text-slate-700 mb-1.5">Prioritet</label>
            <select
              name="priority"
              value={form.priority}
              onChange={handleChange}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-[13px] font-bold text-slate-700 mb-1.5">Başlama Tarixi</label>
            <input
              name="startDate"
              type="date"
          ...
          <div>
            <label className="block text-[13px] font-bold text-slate-700 mb-1.5">Bitmə Tarixi</label>
            <input
              name="endDate"
              type="date"
              value={form.endDate}
        ...
        {/* Color */}
        <div>
          <label className="block text-[13px] font-bold text-slate-700 mb-2">Layihə İkon Rəngi</label>
