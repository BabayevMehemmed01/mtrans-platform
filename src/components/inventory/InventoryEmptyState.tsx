...
// Marketing modulundaki eyni dizayn dilini davam etdirir.
// =============================================================================
...
export function InventoryEmptyState({
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-border/70 bg-muted/20 px-6 py-16 text-center",
        className
      )}
    >
...
export function InventoryTableSkeleton({ rows = 5, cols = 4 }: { rows?: number; cols?: number }) {
  return (
