...
// =============================================================================
// CrmCompanySelect — CRM şirkəti seçimi + lazım gələrsə tez yaratma.
// Deal və Contact formlarında ortaq istifadə olunur.
// =============================================================================
  ...
  return (
    <>
      ...
      >
        ...
        <option value="__create__">+ Yeni şirkət əlavə et...</option>
      </select>

      <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
        <DialogContent className="sm:max-w-[400px]">
          <DialogHeader>
            <DialogTitle>Yeni CRM Şirkəti</DialogTitle>
          </DialogHeader>
