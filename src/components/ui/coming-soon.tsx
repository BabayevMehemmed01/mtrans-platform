  ...
  return (
    <div className="flex h-full min-h-[60vh] flex-col items-center justify-center text-center p-8">
      <div className="relative mb-6">
        ...
        <div className="relative flex h-20 w-20 items-center justify-center rounded-2xl bg-card border border-border shadow-sm">
          {icon ? icon : <Construction className="h-10 w-10 text-primary" />}
        </div>
      </div>
