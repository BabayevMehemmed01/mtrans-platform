...
export default async function OnboardingPage() {
  ...
  if ((session.user as any).companyId) redirect("/dashboard/my-work");
    ...
    <div className="min-h-screen flex items-center justify-center bg-muted p-4">
      <div className="max-w-md w-full bg-card border border-border rounded-2xl shadow-sm p-8 text-center">
        ...
        <div className="flex flex-col gap-2">
          <a
            href="/register"
            className="inline-flex items-center justify-center h-10 rounded-lg bg-primary text-primary-foreground text-sm font-medium hover:bg-primary/90 transition-colors"
          >
          ...
          >
            <button
              type="submit"
              className="w-full inline-flex items-center justify-center h-10 rounded-lg border border-border text-sm font-medium hover:bg-accent transition-colors"
            >
              Çıxış Et
            </button>
          </form>
